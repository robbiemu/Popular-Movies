...
//                Log.d(LOG_TAG, "loading poster for movie " + title);
                ...
                break;
            case "local-svg":
                String svgString = Prefs.getString(url, "<svg></svg>");
                Log.d(LOG_TAG, svgString);
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Error with stashed SVG for url '"+url+"', removing stashed SVG. error:" +  e.getMessage());
                    //e.printStackTrace();
                }
